...
<AccordionGroup>
  ...
  <Accordion title="Embedding Model Selection">
    ...
    | `gemini-embedding-001` | 3072 | HNSW (halfvec) | Google Gemini — free tier (100 RPM), OpenAI-compatible endpoint |
    ...
    # Google Gemini via OpenAI-compatible endpoint (free tier: 100 RPM)
